    ...
    <div className="w-full bg-white dark:bg-neutral-950 font-sans md:px-10" ref={containerRef} >
      <div className="max-w-7xl mx-auto pt-20 pb-8 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-sm">
          A collection of projects I&apos;ve built over the years. Here&apos;s a timeline of my work.
        </p>
        <div className="mt-6">
          <a 
            href="#experience" 
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          <div key={index} className={`flex justify-start md:gap-10 ${index === 0 ? "pt-4 md:pt-10" : "pt-10 md:pt-40"}`} >
